...
#define HANDLER(name) void name(ExecutionState &state, \
    ...
    // hash table handlers
    HANDLER(handleTest);
    HANDLER(handleTableInit);
    HANDLER(handleTableAccess);
    HANDLER(handleTableCheck);
    ...
    // BF handlers
    HANDLER(handleBFInit);
    HANDLER(handleBFAccess);
    HANDLER(handleBFRead);

    // Cmin handlers
    HANDLER(handleCminInit);
    HANDLER(handleCminAdd);
    HANDLER(handleCminLargerThan);

    // MA table handlers
    HANDLER(handleMAInit);
    HANDLER(handleMAAccess);
    HANDLER(handleMARead);
    HANDLER(handleMAInsert);

    // General query handler
    // HANDLER(handleQuery);

    // Telescope handlers
    HANDLER(handleTSIinit);
    HANDLER(handleTSPkt);
    HANDLER(handleTS);
